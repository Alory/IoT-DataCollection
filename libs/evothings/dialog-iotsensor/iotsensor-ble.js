...
;(function()
{
	...
	iotsensor.addInstanceMethods = function(anInstance)
	{
		...
		{
			console.log('gyroscopeCallback2')
		...
		{
			//console.log("getAccelerometerValues!!!")
			var sensitvity = 1;
			...
			var values = { x: ax, y: ay, z: az }
			var now = Date.now();
			var data = {"time":parseInt(now/1000),sensor:"accelerometer",address:instance.address,payload:values,unit:"g"}
			//var data = {"time":now,sensor:"accelerometer",address:instance.address,payload:values,unit:"g"}
		...
		{	
			//console.log("getGyroscopeValues!!!")
			var sensitvity = 1;
			...
			var values = { x: ax, y: ay, z: az }
			var now = Date.now();
			var data = {"time":parseInt(now/1000),sensor:"gyroscope",address:instance.address,payload:values,unit:"deg/s"}
			//var data = {"time":now,sensor:"gyroscope",address:instance.address,payload:values,unit:"deg/s"}
		...
		function getMagnetometerValues(data)
		{
			...
			var values = { x: ax, y: ay, z: az }
			var data = {sensor:"magnetometer",address:instance.address,payload:values,unit:"g"}
		...
		function getBarometerValue(data)
		{
			...
			var data = {sensor:"barometer",address:instance.address,payload:pressure,unit:"hPa"}
		...
		function getTemperatureValue(data)
		{
			...
			var sensorTemp = {sensor:"temperature",address:instance.address,payload:temperature,unit:"celsius"}
